    ...
    <div className="pointer-events-none fixed bottom-[calc(var(--spacing-bottom-tab)+24px)] left-1/2 z-20 w-full max-w-layout -translate-x-1/2 px-6">
      <div className="flex justify-end">
        <button
          ...
          className={`pointer-events-auto flex size-11 cursor-pointer items-center justify-center rounded-full bg-semantic-object-inverse shadow-[0px_2px_12px_0px_rgba(0,0,0,0.25)] transition-all duration-200 ${
            visible
