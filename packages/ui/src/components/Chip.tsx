...
const chipVariants = cva(
  'inline-flex cursor-pointer items-center justify-center whitespace-nowrap rounded-full transition-colors disabled:cursor-not-allowed focus-visible:outline-2 focus-visible:outline-offset-1',
  {
    variants: {
      ...
      size: {
        sm: 'label-sm gap-1.5 px-3 py-2 [&_svg]:size-3.25 [&_svg]:shrink-0 [&_svg]:fill-current',
        lg: 'label-lg gap-2.5 px-4 py-3 [&_svg]:size-3.25 [&_svg]:shrink-0 [&_svg]:fill-current',
      },
    },
    defaultVariants: {
      selected: false,
